...
from agent_smith.core.permissions.types import CanUseTool, PermissionDecision, PermissionRequest
...
def create_can_use_tool(
    *,
    ...
    async def can_use_tool(request: PermissionRequest) -> PermissionDecision:
        ...
        from agent_smith.core.tools.ask_user.tool import AskUserQuestionRequest, AskUserQuestionResponse
