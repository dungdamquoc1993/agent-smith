...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "BIO_TOOL_NAME": ("agent_smith.core.tools.bio.constants", "BIO_TOOL_NAME"),
    "BioToolInput": ("agent_smith.core.tools.bio.tool", "BioToolInput"),
    "create_bio_tool": ("agent_smith.core.tools.bio.tool", "create_bio_tool"),
