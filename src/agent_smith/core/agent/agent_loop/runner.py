...
from agent_smith.core.llm.types import ToolResultMessage
from agent_smith.core.agent.agent_loop.streaming import stream_assistant_response
from agent_smith.core.agent.agent_loop.tools import execute_tool_calls, get_tool_calls
from agent_smith.core.agent.agent_loop.utils import (
    call_maybe,
    coerce_turn_update,
    emit,
    get_messages,
